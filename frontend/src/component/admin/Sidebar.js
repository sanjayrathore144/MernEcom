...
'</div>';
  ...
  //       var defaultaccordion = $(".accordion .card-header"),
...
<div class="main-menu menu-fixed menu-light menu-accordion menu-shadow" data-scroll-to-active="true">
  <div class="navbar-header">
    <ul class="nav navbar-nav flex-row">
      <li class="nav-item mr-auto"><a class="navbar-brand" href="index.html">
          ...
          <h2 class="brand-text mb-0">Ecommerce</h2></a></li>
  ...
  <div class="main-menu-content">
    <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation" data-icon-style="lines">
      <li class=" nav-item dash has-sub sidebar-group-active"><a ><span>Dashboard</span></a>
      </li>
      <li class=" navigation-header text-truncate"><span data-i18n="Apps">Lists</span>
      </li>
     
      <li class=" nav-item has-sub"><a href="#"><i class="menu-livicon" data-icon="notebook"></i><span class="menu-title text-truncate" data-i18n="Invoice">List of category</span></a>
        <ul class="menu-content">
          <li> <Link to="/categories" class="d-flex align-items-center" href=""><i class="bx bx-right-arrow-alt"></i><span class="menu-item text-truncate" data-i18n="Invoice List">Category</span></Link>
          </li>
          <li> <Link to="/subcategory" class="d-flex align-items-center"><i class="bx bx-right-arrow-alt"></i><span class="menu-item text-truncate" data-i18n="Invoice">Add Subcategory</span></Link>
          </li>
        </ul>
      </li>

      <li class=" nav-item has-sub"><a href="#"><i class="menu-livicon" data-icon="notebook"></i><span class="menu-title text-truncate">Product</span></a>
        <ul class="menu-content">
          <li> <Link to="/product" class="d-flex align-items-center" href=""><i class="bx bx-right-arrow-alt"></i><span class="menu-item text-truncate">List Product</span></Link>
          </li>
          <li> <Link to="/create_product" class="d-flex align-items-center"><i class="bx bx-right-arrow-alt"></i><span class="menu-item text-truncate" >Create Product</span></Link>
          </li>
        </ul>
      </li>
